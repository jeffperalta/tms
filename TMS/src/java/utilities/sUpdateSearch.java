 ...
 * @author jperalta
 */
public class sUpdateSearch extends HttpServlet {
 ...
 ******************************************************************************/
    if(_ButtonClicked.compareToIgnoreCase("filter") == 0) {
        response.sendRedirect("/TMS/webpages/Admin/SearchPage/UpdateSearch.jsp#" + _ButtonClicked);
    }
 ...
 *--Refresh Section--                                                         *
 ******************************************************************************/
    _MyMessage.setMessageTitle(request.getParameter("txtTitle").trim());
