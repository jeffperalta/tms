...
<jsp:useBean  id="myAddDefaultActivityPage" class="beans.pages.DefaultActivityPage" scope="session"/>
...
<%
    ...
    beans.pages.DefaultActivityPage _MyPage =(beans.pages.DefaultActivityPage)session.getAttribute("myAddDefaultActivityPage");
...
<div id="page">
	<div id="content">
		...
		<form id="form2" method="post" action="/TMS/sAddDefaultActivity">
		<div id="example" class="post">
			<h2 class="title"> Add Default Activity Info<a name="main" id="main"></a><a name="Save" id="Save"></a> </h2>
			<h3>[<a href="AdminDefaultActivity.jsp#main">Go back to Edit Activity Info</a>]</h3>
			<div class="content">
			  <fieldset>
				<ul>
				  <li>
