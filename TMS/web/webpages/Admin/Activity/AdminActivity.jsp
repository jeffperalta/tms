...
<jsp:useBean  id="myActivityPage" class="beans.pages.ActivityPage" scope="session"/>
...
<%
    ...
    beans.pages.ActivityPage _MyPage =(beans.pages.ActivityPage)session.getAttribute("myActivityPage");
...
<div id="page">
	<div id="content">
		...
		<form id="form2" method="post" action="/TMS/sEditActivity">
		<div id="example" class="post">
			<h2 class="title"> Edit Activity Info<a name="activityid" id="activityid"></a> <a name="projectid" id="projectid"></a><a name="Save" id="Save"></a><a name="Delete" id="Delete"></a></h2>
			<div class="content">
			  <fieldset>
				<ul>
					<li>
						...
						<label for="txtProjectID">Activity ID: </label> 
						<strong><%=_MyPage.getActivityID()%></strong>
					...
					<li><input id="glbutton" type="submit" name="glbutton" value="Save" <%=myUser.checkAccess(constants.Actions.LEAVE_EDIT)%>/> 
					  <input id="glbutton" type="submit" name="glbutton" value="Delete" <%=myUser.checkAccess(constants.Actions.LEAVE_DELETE)%>/>
					</li>
				</ul>
			  </fieldset>
			  <h3>[<a href="AdminActivityPlus.jsp#main">Add New</a>]</h3>
			</div>
		</div>
		</form>
	</div>
