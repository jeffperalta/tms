...
<%
	...
	beans.Activity _MyActivity = (beans.Activity)session.getAttribute("BActivity");
%>
...
<div id="page">
	<div id="content">
		...
		<div id="example" class="post">
			<h2 class="title"> Activity Log Per  Activity Report </h2>
			<div class="content">
				<form id="form2" method="post" action="/TMS/sAdminActivityLogPerActivity">
					<fieldset>
					<ul>
						<li>
						  <label for="txtActivityID"><span class="RedIndicator">*</span>Activity ID: </label>
						  <input name="txtActivityID" type="text" id="txtActivityID" value="<%=_MyActivity.getActivityID()%>" size="22" maxlength="20" />
						  <input name="glbutton" type="image" value="activityid" id="glbutton" src="../../../images/search1.gif" width="28" height="20" border="0" />
						  <span class="Caption"><%=_MyActivity.getActivityName()%></span>
						</li>
						<li>
