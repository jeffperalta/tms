...
<%
	...
	beans.Project _MyProject = (beans.Project)session.getAttribute("BProject");
%>
...
<div id="page">
	<div id="content">
		...
		<div id="example" class="post">
			<h2 class="title"> Activity Log Per  Project Report </h2>
			<div class="content">
				<form id="form2" method="post" action="/TMS/sAdminActivityLogPerProject">
					<fieldset>
					<ul>
						<li>
						  <label for="txtProjectID"><span class="RedIndicator">*</span>Project ID: </label>
						  <input name="txtProjectID" type="text" id="txtProjectID" value="<%=_MyProject.getProjectID()%>" size="22" maxlength="20" />
						  <input name="glbutton" type="image" value="projectid" id="glbutton" src="../../../images/search1.gif" width="28" height="20" border="0" />
						  <span class="Caption"><%=_MyProject.getProjectName()%></span>
						</li>
						<li>
			...
			<ol>
				<li>I want a complete list of billable logs for this project within this particular dates.</li>
				<li>How many man hours were rendered for this project today?</li>
		      	<li>Who are the employees that participated in this project?</li>
	        </ol>
		</div>
  	</div>
	<div id="sidebar">
