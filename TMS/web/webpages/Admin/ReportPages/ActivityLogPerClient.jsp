...
<%
	...
	myReportData = (Report.ReportData)session.getAttribute("myReportData");
...
<div id="page">
	<div id="content">
		...
		<div id="example" class="post">
			<h2 class="title"> Activity Log Per Client Report </h2>
			<div class="content">
				<form id="form2" method="post" action="/TMS/sAdminActivityLogPerClient">
					<fieldset>
					<ul>
						<li>
						  <label for="txtClientID"><span class="RedIndicator">*</span>Client ID: </label>
						  <input name="txtClientID" type="text" id="txtClientID" value="<%=_MyClient.getClientId()%>" size="22" maxlength="20" />
						  <input name="glbutton" type="image" value="clientid" id="glbutton" src="../../../images/search1.gif" width="28" height="20" border="0" />
						  <span class="Caption"><%=_MyClient.getName()%></span>
						</li>
						<li>
			...
			<ol>
				<li>I want a complete list of billable logs from all projects that belong to a certain client from January 1, 2000 to January 1, 2001.</li>
				<li>How many man hours were rendered for all the projects belonging to a certain client today?</li>
		      	<li>Who are the employees that participated in all the projects of a client for this period?</li>
	        </ol>
