...
<jsp:useBean  id="myActivityAssignmentPageAdd" class="beans.pages.ActivityAssignmentPage" scope="session"/>
...
<%
    ...
    beans.pages.ActivityAssignmentPage _MyPage =(beans.pages.ActivityAssignmentPage)session.getAttribute("myActivityAssignmentPageAdd");
...
<div id="page">
	<div id="content">
		<div id="welcome" class="post">
			<h1 class="title">Project Assignment  Information</h1>
		...
		<form id="form2" method="post" action="/TMS/sActivityAssignmentAdd">
		<div id="example" class="post">
			<h2 class="title"> New Project Assignment<a name="main" id="main"></a><a name="activityid" id="activityid"></a><a name="userid" id="userid"></a><a name="Save" id="Save"></a></h2>
			<h3>[<a href="AdminActivityAssignment.jsp#main">Go back to Edit Project Assignment</a>]</h3>
			<div class="content">
			  <fieldset>
				<ul>
					<li>
				        <label for="txtClientID">Project Name: </label> 
					    <strong><%=_MyPage.getProjectName()%>
						</strong><input name="glbutton" type="image" value="activityid" id="glbutton" src="../../../images/search1.gif" width="28" height="20" border="0" />
					</li>
					<li>
						<label for="txtClientID"><span class="RedIndicator">*</span>Employee Name: </label> 
			        ...
			        <li>
						<input id="glbutton" type="submit" name="glbutton" value="Save" <%=myUser.checkAccess(constants.Actions.ACTIVITY_ASSIGNMENT_CREATE)%>/> 
					</li>
				</ul>
			  </fieldset>
			</div>
