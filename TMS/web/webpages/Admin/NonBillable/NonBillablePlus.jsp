...
<jsp:useBean  id="myAddNonBillablePage" class="beans.pages.NonBillablePage" scope="session"/>
...
<%
    ...
    beans.pages.NonBillablePage _MyPage =(beans.pages.NonBillablePage)session.getAttribute("myAddNonBillablePage");
...
<div id="page">
	<div id="content">
		<div id="welcome" class="post">
			<h1 class="title">Non Billable Information</h1>
		...
		<form id="form2" method="post" action="/TMS/sAddNonBillable">
		<div id="example" class="post">
			<h2 class="title"> Add Non Billable Info<a name="main" id="main"></a><a name="Save" id="Save"></a> </h2>
			<h3>[<a href="NonBillable.jsp#main">Go back to Edit Non Billable Info</a>]</h3>
			<div class="content">
			  <fieldset>
				<ul>
					<li>
						<label for="txtNonBillableID"><span class="RedIndicator">*</span>Non Billable  ID: </label> 
						<input name="txtNonBillableID" type="text" id="txtNonBillableID" value="<%=_MyPage.getNonBillableID()%>" size="10" maxlength="4" />
			        </li>
					<li>
				  ...
				  <li>
						<input id="glbutton" type="submit" name="glbutton" value="Save" <%=myUser.checkAccess(constants.Actions.NON_BILLABLE_CREATE)%>/> 
				  </li>
				</ul>
			  </fieldset>
