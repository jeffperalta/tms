...
<jsp:useBean  id="myNonBillableStatusPage" class="beans.pages.NonBillableStatusPage" scope="session"/>
...
<%
    ...
    beans.pages.NonBillableStatusPage _MyPage =(beans.pages.NonBillableStatusPage)session.getAttribute("myNonBillableStatusPage");
...
<div id="page">
	<div id="content">
		<div id="welcome" class="post">
			<h1 class="title">Non Billable Security<a name="main" id="main"></a></h1>
		...
		<form id="form2" method="post" action="/TMS/sAdminNonBillableStatus">
		<div id="example" class="post">
			<h2 class="title"> Non-Billable Unlock/Lock<a name="userid" id="userid"></a><a name="Filter" id="Filter"></a> </h2>
				  	...
				  	<li>
						<%
							...
							if(_MyPage.getUserID().trim().length() == 0) {
								strPrompt = "<span class='CommentStyle'><em>Search the user to view all his activity history</em></span>";
							}
						%>
		...
		<p><span class="CommentStyle"><em>Lock/Unlock deletion of non-billable activities.</em></span></p>
		<div id="table_listing">
			<a name="Save" id="Save"></a>
			<div class="content">
				<table width="100%" cellspacing="0" cellpadding="0">
					<tr bgcolor="#3B3B3B">
					  <td width="53" height="13" class="RowHeader">Locked</td>
					  <td width="88" class="RowHeader">Date</td>
					  <td width="143" class="RowHeader">Non-Billable</td>
					  <td width="212" class="RowHeader">Remarks</td>
					</tr>
					<%
						tmsclass.nonbillables.queryAnalyzer QA = new tmsclass.nonbillables.queryAnalyzer();
					%>
					<%=QA.showNonBillables(_MyPage)%>
				</table>
	...
	<div id="sidebar">
		...
		<div id="menu">
			<ul>
				...
				<li class="active"><a href="NonBillable.jsp" title=""> Non-Billables</a></li>
