...
<jsp:useBean  id="myEditNonBillablePage" class="beans.pages.NonBillablePage" scope="session"/>
...
<%
    ...
    beans.pages.NonBillablePage _MyPage =(beans.pages.NonBillablePage)session.getAttribute("myEditNonBillablePage");
...
<div id="page">
	<div id="content">
		<div id="welcome" class="post">
			<h1 class="title">Non Billable Information<a name="main" id="main"></a></h1>
		...
		<form id="form2" method="post" action="/TMS/sEditNonBillable">
		<div id="example" class="post">
			<h2 class="title"> Edit Non Billable Info<a name="nonbillableid" id="nonbillableid"></a><a name="Save" id="Save"></a><a name="Delete" id="Delete"></a> </h2>
			<h3>[<a href="NonBillablePlus.jsp#main">Go to Add New Billable Info </a>]</h3>
			<div class="content">
			  <fieldset>
				<ul>
					<li>
						<%
							String strPrompt = " ";
							if(_MyPage.getNonBillableID().trim().length() == 0) {
								strPrompt = "<span class='CommentStyle'><em>Search the non-billable that you want to edit.</em></span>";
							}
						%>
						<label for="txtNonBillableID">Non Billable  ID: </label> 
						<strong><%=_MyPage.getNonBillableID()%></strong>
						<input name="glbutton" type="image" value="nonbillableid" id="glbutton" src="../../../images/search1.gif" width="28" height="20" border="0" />
						<%=strPrompt%>
			        </li>
					<li>
						<label for="txtName"><span class="RedIndicator">*</span>Name: </label>
						<input name="txtName" type="text" id="txtName" value="<%=_MyPage.getName()%>" size="30" maxlength="50" />
					</li>
				  	<li>
						<%
							String strStatus = " ";
					...
					<li>
						<input id="glbutton" type="submit" name="glbutton" value="Save" <%=myUser.checkAccess(constants.Actions.NON_BILLABLE_EDIT)%>/> 
					  	<input id="glbutton" type="submit" name="glbutton" value="Delete" <%=myUser.checkAccess(constants.Actions.NON_BILLABLE_DELETE)%>/>
					</li>
				</ul>
			  </fieldset>
			  <h3>[<a href="AdminNonBillableStatus.jsp#main">Non-Billable Activity Security Settings</a>]</h3>
			  <p align="right"><a href="/TMS/sListing?rt=NBL">View Non-Billable Activity Listing Report</a></p>
			</div>
		</div>
		</form>
	</div>
	<div id="sidebar">
		<div id="menu">
			<ul>
				...
				<li class="active"><a href="../NonBillable/NonBillable.jsp" title=""> Non-Billables</a></li>
