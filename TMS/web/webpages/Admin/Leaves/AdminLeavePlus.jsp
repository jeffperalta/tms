...
<jsp:useBean  id="myAddLeavePage" class="beans.pages.LeavePage" scope="session"/>
...
<%
    ...
    beans.pages.LeavePage _MyPage =(beans.pages.LeavePage)session.getAttribute("myAddLeavePage");
...
<div id="page">
	<div id="content">
		<div id="welcome" class="post">
			<h1 class="title">Leave Information</h1>
		...
		<form id="form2" method="post" action="/TMS/sAddLeavePage">
		<div id="example" class="post">
			<h2 class="title"> Add Leave Info<a name="main" id="main"></a><a name="Save" id="Save"></a> </h2>
			...
			<div class="content">
			  <fieldset>
				<ul>
					...
					<li>
						<label for="txtMaxLeave"><span class="RedIndicator">*</span>Default Max Leave: </label>
					...
					<li>
						<input id="glbutton" type="submit" name="glbutton" value="Save" <%=myUser.checkAccess(constants.Actions.LEAVE_CREATE)%> /> 
					</li>
				</ul>
			  </fieldset>
