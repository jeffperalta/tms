...
<jsp:useBean  id="myUserSearchPage" class="beans.pages.UserSearchPage" scope="session"/>
...
<%
    ...
    beans.pages.UserSearchPage _MyPage =(beans.pages.UserSearchPage)session.getAttribute("myUserSearchPage");
...
<div id="page">
	<div id="content">
		<div id="welcome" class="post">
			<h1 class="title">User Search<a name="main" id="main"></a> </h1>
		...
		<form id="form2" method="post" action="/TMS/sUserSearch">
		...
		<div id="table_listing">
			<div class="content">
				<table width="100%" cellspacing="0" cellpadding="0">
					<tr bgcolor="#3B3B3B">
					  <td width="134" class="RowHeader">Name</td>
					   <td width="141" class="RowHeader">Department</td>
					  <td width="144" class="RowHeader">Contact</td>
				      <td width="77"><div class="RowHeader">Date Entered </div></td>
					</tr>
					<%
