...
<jsp:useBean  id="myEditClientPage" class="beans.pages.EditClientPage" scope="session"/>
...
<%
    ...
    beans.pages.EditClientPage _MyPage =(beans.pages.EditClientPage)session.getAttribute("myEditClientPage");
...
<div id="page">
	<div id="content">
		<div id="welcome" class="post">
			<h1 class="title">Client Information<a name="main" id="main"></a></h1>
		...
		<form id="form2" method="post" action="/TMS/sEditClientPage">
		<div id="example" class="post">
			<h2 class="title"> Edit Client Info<a name="clientid" id="clientid"></a><a name="Save" id="Save"></a><a name="Delete" id="Delete"></a> </h2>
			<h3>[<a href="AdminClientPlus.jsp#main">Go to Add New Client Info</a>]</h3>
			<div class="content">
			  <fieldset>
				<ul>
					<li>
						<%
							...
							if(_MyClient.getClientId().trim().length() == 0) {
								strPrompt = "<span class='CommentStyle'><em>Search the client info that you want to edit.</em></span>";
							}
						%>
						
						<label for="txtClientID">Client ID: </label> 
						<strong><%=_MyClient.getClientId()%></strong>
					...
					<li>
						...
						<input name="txtName" type="text" id="txtName" value="<%=_MyClient.getName()%>" size="30" maxlength="50" />
					</li>
					<li>
						<label for="txtAddress">Address: </label>
						<input name="txtAddress" type="text" id="txtAddress" value="<%=_MyClient.getAddress()%>" size="30" maxlength="50" />
					</li>
					<li>
						<label for="txtContact">Contact: </label>
						<input name="txtContact" type="text" id="txtContact" value="<%=_MyClient.getContact()%>" size="30" maxlength="50" />
					</li>
					<li>
						<label for="txtFax">Fax: </label>
						<input name="txtFax" type="text" id="txtFax" value="<%=_MyClient.getFax()%>" size="30" maxlength="50" />
					</li>
					<li>
						<label for="txtContactPerson">Contact Person: </label>
						<input name="txtContactPerson" type="text" id="txtContactPerson" value="<%=_MyClient.getContactPerson()%>" size="30" maxlength="50" />
					</li>
				  	<li>
						<label for="txtRemarks">Remarks: </label> 
                        <textarea name="txtRemarks" cols="45" rows="2" id="txtRemarks"><%=_MyClient.getComment()%></textarea>
					</li>
					<li><input id="glbutton" type="submit" name="glbutton" value="Save" <%=myUser.checkAccess(constants.Actions.CLIENT_EDIT)%>/> 
					  <input id="glbutton" type="submit" name="glbutton" value="Delete" <%=myUser.checkAccess(constants.Actions.CLIENT_DELETE)%>/>
					</li>
				</ul>
			  </fieldset>
