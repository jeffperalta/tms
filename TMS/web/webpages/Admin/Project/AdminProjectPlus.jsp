...
<jsp:useBean  id="myAddProjectPage" class="beans.pages.ProjectPage" scope="session"/>
...
<%
    ...
    beans.pages.ProjectPage _MyPage =(beans.pages.ProjectPage)session.getAttribute("myAddProjectPage");
...
<div id="page">
	<div id="content">
		...
		<form id="form2" method="post" action="/TMS/sAddProject">
		<div id="example" class="post">
			<h2 class="title"> Add Project Info<a name="main" id="main"></a><a name="clientid" id="clientid"></a><a name="Save" id="Save"></a> </h2>
			<h3>[<a href="AdminProject.jsp#main">Go back to Edit Project Info</a>]</h3>
			<div class="content">
			  <fieldset>
				<ul>
					<li>
					...
					<li><input id="glbutton" type="submit" name="glbutton" value="Save" <%=myUser.checkAccess(constants.Actions.PROJECT_CREATE)%>/> 
					</li>
				</ul>
			  </fieldset>
			</div>
