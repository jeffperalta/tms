...
<%
	...
	beans.NonBillableType myType = (beans.NonBillableType)session.getAttribute("BNonBillableType");
	beans.pages.NonBillableTypeSearchPage myPage = (beans.pages.NonBillableTypeSearchPage)session.getAttribute("PNonBillableTypePage");
%>
...
<div id="page">
	<div id="content">
		<div id="welcome" class="post">
			<h1 class="title">Non Billable Type  Search<a name="main" id="main"></a></h1>
		...
		<form id="form2" method="post" action="/TMS/NonBillableSearch">
		<div id="example" class="post">
			...
			<div class="content">
				...
				<ul>
					  ...
					  <input name="txtName" type="text" id="txtName" value="<%=myType.getNonBillableTypeName()%>" size="30" maxlength="50">
					</li>
