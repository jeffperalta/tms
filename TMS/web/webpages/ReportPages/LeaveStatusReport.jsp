...
<div id="page">
	<div id="content">
		...
		<div id="example" class="post">
			<h2 class="title"> Leave Status Report </h2>
			<div class="content">
				<form id="form2" method="post" action="/TMS/sLeaveStatusReport">
					<fieldset>
					<ul>
						<li>
						  <label for="txtYear"><span class="RedIndicator">*</span>Year: </label>
						  <input name="txtYear" type="text" id="txtYear" value="<%=_MyReportData.getYearNum()%>" size="22" maxlength="20" />
						</li>
			...
			<h3>What is this report all about?</h3>
		   	<ol>
              <li>What are the available work leaves?</li>
              <li>What are my remaining or available work leaves for this year?</li>
              <li>What is my maximum leave count for all available work leaves?</li>
              <li>How many days was I absent because of sickness last year?</li>
          </ol>
		</div>
  	</div>
	<div id="sidebar">
