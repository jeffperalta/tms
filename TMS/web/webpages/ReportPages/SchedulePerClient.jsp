...
<div id="page">
	<div id="content">
		...
		<div id="example" class="post">
			<h2 class="title"> Time Log Per Client Report </h2>
			<h3 class="title">[<a href="TimeLogReports.jsp">Go back to General Timelog Reports</a>]</h3>
			<div class="content">
				<form id="form2" method="post" action="/TMS/sSchedulePerClientReport">
					<fieldset>
					<ul>
						<li>
			...
			<h3>What is this report all about?</h3>
		   	<ol>
				<li>What is my work history for this client?</li>
				<li>How many hours were rendered for all the projects of this client?</li>
	   	  	</ol>
		</div>
  	</div>
	<div id="sidebar">
