...
<div id="page">
	<div id="content">
		...
		<div id="example" class="post">
			...
			<div class="content">
				<form id="form2" method="post" action="/TMS/sActivityPerMonthReport">
					<fieldset>
					<ul>
					  <li>
			...
			<h3>What is this report all about?</h3>
		   	<ol>
              <li>How many hours per day where submitted for this project for the whole month of May 2005?</li>
              <li>Did I have an under time for the month of May 2005? What are the days that I have an over time?</li>
              <li>Did I have a half day leave on May 15, 2005?</li>
              <li>Did we have a brainstorming/ internal meeting for this particular project on the month of May 2005?</li>
          	</ol>
		</div>
  	</div>
	<div id="sidebar">
